...
namespace Nmodbus_teste
{
    ...
    public class Driver
    {
        private const string PrimarySerialPortName = "COM11";
        private const string SecondarySerialPortName = "COM12";
        ...
        private static Task StartModbusSerialRtuSlaveWithCustomMessage(CancellationToken token)
        {
